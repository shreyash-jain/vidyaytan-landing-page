...
const data = {
  feature: [
    {
      ...
      icon: expand,
      title: '300 ft2',
      description: 'you will get specious facility here.',
    },
    {
      id: 2,
      icon: users,
      title: '50 Members',
      description: 'we prefer quality over quantity',
    },
    {
      id: 3,
      icon: wifi,
  ...
  gallery: [
    ...
    },
    {
      ...
      image: slider2,
      title: 'Study Rooms',
      desc: '3 Types for all kind of students',
    },
    {
      id: 3,
      image: slider3,
      title: 'Breakout Area',
      desc: 'Have Coffee and Study',
    },
  ],
};
      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.leftContent}>
            <SectionHeading
              sx={styles.heading}
              title="Study in Silence, Let your Success be your Noise"
              description="Preparing for UPSC, PSC, SSC, CA, CS, GATE, IIT-JEE, NEET?  Convert your dreams into reality"
            />
